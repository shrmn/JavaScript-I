...
// Help the dealer find out which car has an id of 33 by logging the car's year, make,
// and model in the console log provided to you below:

for (let i = 32; i < 33; i++) {
  let carInfo = inventory[i];
  console.log(
...
carModels.sort();
console.log("Alphabetized car model list: ", carModels);
...
// Using the carYears array you just created, find out how many cars were made before
...
// Return an array that only contains BMW and Audi cars.  Once you have populated the
// BMWAndAudi array, use JSON.stringify() to show the results of the array in the console.
let BMWAndAudi = [];
