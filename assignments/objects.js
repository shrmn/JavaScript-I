...
// TypeError: interns[0].name is not a function
...
const parent = {
  name: "Susan",
  age: 70,
  speak: function() {console.log("Hello, my name is Susan")},
  child: {
    name: "George",
    age: 50,
    speak: function() {console.log("Hello, my name is George")},
    grandchild: {
      name: "Sam",
      age: 30,
      speak: function() {console.log("Hello, my name is Sam")},
    },
  },
}
